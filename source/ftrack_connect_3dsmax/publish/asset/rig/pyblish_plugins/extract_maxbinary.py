...
class ExtractRigMaxBinary(pyblish.api.InstancePlugin):
    '''Extract rig as max binary.'''
    ...
    def process(self, instance):
        '''Process *instance* and extract rig.'''
        import MaxPlus
...
pyblish.api.register_plugin(ExtractRigMaxBinary)
